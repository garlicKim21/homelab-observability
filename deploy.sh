...
REQUIRED_VARS=(OCI_INSTANCE_IP AP_IP FIREWALL_IP_1 FIREWALL_IP_2 FIREWALL_IP_3 ESXI_IP_PATTERN NAS_IP SNMP_AUTH_PASS SNMP_PRIV_PASS SNMP_AP_AUTH_PASS SNMP_AP_PRIV_PASS SNMP_USERNAME SNMP_AP_USERNAME OPNSENSE_HOST SWITCH_HOST NAS_HOST OCI_SG_COMPARTMENT_OCID)
